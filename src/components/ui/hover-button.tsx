    ...
    return (
      <button
        ...
        className={cn(
          ...
          "before:z-[1]",
          "before:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.25),inset_0_0_16px_0_rgba(255,255,255,0.12),inset_0_-3px_12px_0_rgba(212,175,55,0.18),0_1px_3px_0_rgba(0,0,0,0.40),0_4px_12px_0_rgba(0,0,0,0.30)]",
